...
let
  signedPdf = fetchurl {
    url = "https://raw.githubusercontent.com/c2pa-org/public-testfiles/main/legacy/1.4/pdf/adobe-20240110-single_manifest_store.pdf";
    hash = "sha256-eZChGBkkR/eibAfXdpP3RSYAdP0jRvz1/f6IBnQq1ks=";
  };
in
